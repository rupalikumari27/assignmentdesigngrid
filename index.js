...
var secionTitle1 = document.createElement("h2")
secionTitle1.className="section-heading";
secionTitle1.innerText="Clothing for Men and Women"
clothingSection.appendChild(secionTitle1)
mainBody.appendChild(clothingSection);

var accessoriesSection = document.createElement("section");
var secionTitle2 = document.createElement("h2")
secionTitle2.className="section-heading";
secionTitle2.innerText="Accessories for Men and Women"
accessoriesSection.appendChild(secionTitle2)
mainBody.appendChild(accessoriesSection);

var cardHolder1 = document.createElement("div");
cardHolder1.className="card_bar";
clothingSection.appendChild(cardHolder1);

var cardHolder2 = document.createElement("div");
cardHolder2.className="card_bar";
accessoriesSection.appendChild(cardHolder2);
...
// header1.className="prod_name";
// header1.innerText="Men Navy Blue Solid Sweatshirt"
// card1.appendChild(header1);
// var p1 = document.createElement("p");
// p1.className="brand_name";
// p1.innerText="United Colors of Benetton";
// card1.appendChild(p1);
// var prc1 = document.createElement("P");
// prc1.className="price_tag";
// prc1.innerText="RS 2599";
// card1.appendChild(prc1);
// cardHolder1.appendChild(card1);

// var card2 = document.createElement("div");
// card2.className="card_wrapper";
...
// header2.className="prod_name";
// header2.innerText="Men Black MAMGP T7 Sweat Sporty Jacket"
// card2.appendChild(header2);
// var p2 = document.createElement("p");
// p2.className="brand_name";
// p2.innerText="Puma";
// card2.appendChild(p2);
// var prc2 = document.createElement("P");
// prc2.className="price_tag";
// prc2.innerText="RS 2599";
// card2.appendChild(prc2);
// cardHolder1.appendChild(card2);

// var card3 = document.createElement("div");
// card3.className="card_wrapper";
...
// header3.className="prod_name";
// header3.innerText="Men Black Action Parkview Lifestyle Shoes"
// card3.appendChild(header3);
// var p3 = document.createElement("p");
// p3.className="brand_name";
// p3.innerText="Hush Puppies";
// card3.appendChild(p3);
// var prc3 = document.createElement("P");
// prc3.className="price_tag";
// prc3.innerText="RS 2599";
// card3.appendChild(prc3);
// cardHolder1.appendChild(card3);

// var card4 = document.createElement("div");
// card4.className="card_wrapper";
...
// header4.className="prod_name";
// header4.innerText="Women Black Solid Lightweight Leather Jacket"
// card4.appendChild(header4);
// var p4 = document.createElement("p");
// p4.className="brand_name";
// p4.innerText="BARESKIN";
// card4.appendChild(p4);
// var prc4 = document.createElement("P");
// prc4.className="price_tag";
// prc4.innerText="RS 2599";
// card4.appendChild(prc4);
// cardHolder1.appendChild(card4);


// var card5 = document.createElement("div");
// card5.className="card_wrapper";
...
// var header5 = document.createElement("h3");
// header5.className="prod_name";
// header5.innerText="Women Blue Solid Shirt Dress"
// card5.appendChild(header5);
// var p5 = document.createElement("p");
// p5.className="brand_name";
// p5.innerText="SASSAFRAS";
// card5.appendChild(p5);
// var prc5 = document.createElement("P");
// prc5.className="price_tag";
// prc5.innerText="RS 2599";
// card5.appendChild(prc5);
// cardHolder1.appendChild(card5);


// var card6 = document.createElement("div");
// card6.className="card_container";
...
// header6.className="prod_name";
// header6.innerText="Men Navy Blue Solid Sweatshirt"
// card6.appendChild(header6);
// var p6 = document.createElement("p");
// p6.className="brand_name";
// p6.innerText="United Colors of Benetton";
// card6.appendChild(p6);
// var prc6 = document.createElement("P");
// prc6.className="price_tag";
// prc6.innerText="RS 2599";
// card6.appendChild(prc6);
// cardHolder2.appendChild(card6);

// var card7 = document.createElement("div");
// card7.className="card_container";
...
// header7.className="prod_name";
// header7.innerText="Men Black MAMGP T7 Sweat Sporty Jacket"
// card7.appendChild(header7);
// var p7 = document.createElement("p");
// p7.className="brand_name";
// p7.innerText="Puma";
// card7.appendChild(p7);
// var prc7 = document.createElement("P");
// prc7.className="price_tag";
// prc7.innerText="RS 2599";
// card7.appendChild(prc7);
// cardHolder2.appendChild(card7);

// var card8 = document.createElement("div");
// card8.className="card_container";
...
// var header8 = document.createElement("h3");
// header8.className="prod_name";
// header8.innerText="Men Black Action Parkview Lifestyle Shoes"
// card8.appendChild(header8);
// var p8 = document.createElement("p");
// p8.className="brand_name";
// p8.innerText="Hush Puppies";
// card8.appendChild(p8);
// var prc8 = document.createElement("P");
// prc8.className="price_tag";
// prc8.innerText="RS 2599";
// card8.appendChild(prc8);
// cardHolder2.appendChild(card8);

// var card9 = document.createElement("div");
// card9.className="card_wrapper";
...
// var header9 = document.createElement("h3");
// header9.className="prod_name";
// header9.innerText="Women Black Solid Lightweight Leather Jacket"
// card9.appendChild(header9);
// var p9 = document.createElement("p");
// p9.className="brand_name";
// p9.innerText="BARESKIN";
// card9.appendChild(p9);
// var prc9 = document.createElement("P");
// prc9.className="price_tag";
// prc9.innerText="RS 2599";
// card9.appendChild(prc9);
// cardHolder2.appendChild(card9);


// var card10 = document.createElement("div");
// card10.className="card_wrapper";
...
// var header10 = document.createElement("h3");
// header10.className="prod_name";
// header10.innerText="Women Blue Solid Shirt Dress"
// card10.appendChild(header10);
// var p10 = document.createElement("p");
// p10.className="brand_name";
// p10.innerText="SASSAFRAS";
// card10.appendChild(p10);
// var prc10 = document.createElement("P");
// prc10.className="price_tag";
// prc10.innerText="RS 2599";
// card10.appendChild(prc10);
// cardHolder2.appendChild(card10);

productList.map((data,idx)=>{
    var card10 = document.createElement("div");
    card10.className="card_wrapper";
    var img10 = document.createElement("img");
    img10.src=data.preview;
    img10.alt="card10";
    card10.appendChild(img10);  
    var details_bar = document.createElement("div")
    details_bar.className = "details_bar";
    card10.appendChild(details_bar);
    var header10 = document.createElement("h3");
    header10.innerText=data.name;
    details_bar.appendChild(header10);
    var p10 = document.createElement("h4");
    p10.innerText=data.brand;
    details_bar.appendChild(p10);
    var prc10 = document.createElement("h5");
    prc10.innerText="RS "+data.price;
    details_bar.appendChild(prc10);
    if(data.isAccessory){
        cardHolder2.appendChild(card10);
    }
    else{
        cardHolder1.appendChild(card10);
    }
})